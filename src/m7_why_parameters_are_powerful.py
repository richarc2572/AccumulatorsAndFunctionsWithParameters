...
def better_draw_circles(radius):
    window = rg.RoseWindow(400, 400)
...
def run_test_even_better_draw_circles():
    ...
    print('--------------------------------------------------')
    even_better_draw_circles(3, 50, 0.01)
    even_better_draw_circles(20, 10, 0.1)
    even_better_draw_circles(1, 250, 0.001)


def even_better_draw_circles(radius, n, time):
    window = rg.RoseWindow(400, 400)
